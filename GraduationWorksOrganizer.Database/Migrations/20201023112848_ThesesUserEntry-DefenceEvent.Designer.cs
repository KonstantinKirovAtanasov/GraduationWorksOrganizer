...
namespace GraduationWorksOrganizer.Database.Migrations
{
    ...
    [Migration("20201023112848_ThesesUserEntry-DefenceEvent")]
    partial class ThesesUserEntryDefenceEvent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraduationWorksOrganizer.Database.Models.TeacherDefencesDates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GraduationWorksOrganizer.Database.Models.ThesesUserEntry", b =>
                {
                    ...
                    b.Property<int?>("ThesisDefenceEventId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ThesisDefenceEventId")
                        .IsUnique()
                        .HasFilter("[ThesisDefenceEventId] IS NOT NULL");
            ...
            modelBuilder.Entity("GraduationWorksOrganizer.Database.Models.TeacherDefencesDates", b =>
                {
                    b.HasOne("GraduationWorksOrganizer.Database.Models.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("GraduationWorksOrganizer.Database.Models.ThesesUserEntry", b =>
                {
                    ...
                    b.HasOne("GraduationWorksOrganizer.Database.Models.ThesisDefenceEvent", "ThesisDefenceEvent")
                        .WithOne()
                        .HasForeignKey("GraduationWorksOrganizer.Database.Models.ThesesUserEntry", "ThesisDefenceEventId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
            ...
            modelBuilder.Entity("GraduationWorksOrganizer.Database.Models.ThesisDefenceEvent", b =>
                {
                    b.HasOne("GraduationWorksOrganizer.Database.Models.TeacherDefencesDates", "DefencesDate")
                        .WithMany("Defences")
            ...
            modelBuilder.Entity("GraduationWorksOrganizer.Database.Models.ThesisRequerment", b =>
                {
                    ...
                    b.HasOne("GraduationWorksOrganizer.Database.Models.ThesisMark", "ThesesMark")
                        .WithMany("MarkResults")
                        .HasForeignKey("ThesesMarkId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
